...
const Informe = function () {
  const datosPartidasDefault = {
    Conde: '?', Hombre_Lobo: '?', Biblioteca: '?', Condesa: '?', Fantasma: '?', Salon: '?', Mayordomo: '?', Momia: '?', Panteon: '?', Ama_de_llaves: '?', Drácula: '?', Bodega: '?', Jardinero: '?', Frankenstein: '?', Vestibulo: '?', Doncella: '?', Dr_Jekyll_Mr_Hyde: '?', Cochera: '?', Alcoba: '?', Laboratorio: '?',
  };
